...
namespace HighResolutionApps.VisualControls.HRVPoliceSeatsControl_ZZGA
{
    ...
    class HRVUserControlWrappers : IVisualControlDescriptor
    {
        ...
        public Type Type
        {
            get { return typeof(HRVPoliceSeatsControl_ZZGA); }
        }
        /// <summary>
        /// 组件操作类型
        /// </summary>
        ...
        {
            return new HRVPoliceSeatsControl_ZZGA();
        }
        /// <summary>
        /// 标签
        /// </summary>
    ...
    public class HRVUserControlPropProxy : HighResolutionApps.Common.Schema.BasePropProxy
    {
        ...
        public override PropertyDescriptorCollection GetProperties(Attribute[] attributes)
        {
            ...
            // 自定义属性
            RegisterProperty(typeof(HRVPoliceSeatsControl_ZZGA), "InputDataTable", null, result, "绑定数据。此处无需设置数值，但必须手工在右键绑定数据窗口内，给其创建一个“数据表类型”通道，并绑定需要展示的数据", "数据");
            ...
            RegisterProperty(typeof(HRVPoliceSeatsControl_ZZGA), "IsEditableInOperater", null, result, "是否可以任意移动、改变大小、角度改变", "基础");
            RegisterProperty(typeof(HRVPoliceSeatsControl_ZZGA), "IsMustInOnlyOneMachine", null, result, "是否可以跨屏，跨渲染节点显示", "基础");
            RegisterProperty(typeof(HRVPoliceSeatsControl_ZZGA), "MemoryRequest", null, result, "内存需求", "基础");
            RegisterProperty(typeof(HRVPoliceSeatsControl_ZZGA), "ControlInstanceDes", null, result, "组件示例描述", "基础");
            // 位置尺寸
            ...
            // 组别: 外观
            RegisterProperty(typeof(HRVPoliceSeatsControl_ZZGA), "ControlInstanceMainTitle", null, result, "窗口默认主标题", "外观");
            RegisterProperty(typeof(HRVPoliceSeatsControl_ZZGA), "ControlInstanceSubTitle", null, result, "窗口默认副标题", "外观");
            RegisterProperty(typeof(HRVPoliceSeatsControl_ZZGA), "WindowStyleName", typeof(SelectStylesEditor), result, "样式名称", "外观");
            // 组别：渲染
            RegisterProperty(typeof(HRVPoliceSeatsControl_ZZGA), "RenderMethod", null, result, "加载方式", "渲染");
            RegisterProperty(typeof(HRVPoliceSeatsControl_ZZGA), "RenderOrder", null, result, "渲染优先级", "渲染");
