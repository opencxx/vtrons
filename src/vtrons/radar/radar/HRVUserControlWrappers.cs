...
namespace HighResolutionApps.VisualControls.radar
{
    /// <summary>
    ...
    public class HRVUserControlPropProxy : HighResolutionApps.Common.Schema.BasePropProxy
    {
        ...
        public override PropertyDescriptorCollection GetProperties(Attribute[] attributes)
        {
            ...
            RegisterProperty(typeof(radar), "IsEditableInOperater", null, result, "是否可以任意移动、改变大小、角度改变", "基础");
            RegisterProperty(typeof(radar), "IsMustInOnlyOneMachine", null, result, "是否可以跨屏，跨渲染节点显示", "基础");
            RegisterProperty(typeof(radar), "MemoryRequest", null, result, "内存需求", "基础");
            RegisterProperty(typeof(radar), "ControlInstanceDes", null, result, "组件示例描述", "基础");
            // 位置尺寸
            ...
            // 组别: 外观
            RegisterProperty(typeof(radar), "ControlInstanceMainTitle", null, result, "窗口默认主标题", "外观");
            RegisterProperty(typeof(radar), "ControlInstanceSubTitle", null, result, "窗口默认副标题", "外观");
            RegisterProperty(typeof(radar), "WindowStyleName", typeof(SelectStylesEditor), result, "样式名称", "外观");
            // 组别：渲染
            RegisterProperty(typeof(radar), "RenderMethod", null, result, "加载方式", "渲染");
            RegisterProperty(typeof(radar), "RenderOrder", null, result, "渲染优先级", "渲染");
